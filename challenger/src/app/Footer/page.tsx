                ...
                <div className="logos-footer">
                    <Link href="/Desenvolvedores"><p className="sustentabilidade-footer">Desenvolvedores</p></Link>
                        <div className="todas-redesSociais-footer">
                            <Link href="https://github.com/Marcondezz/sprintThree-SalesForce" target="_blank" className="instagram-footer">
                                <img src={ Instagram.src } className="redes-sociais-icone"/>
                            </Link>
                            <Link href="https://www.facebook.com/SalesforceBrasil/" target="_blank" className="facebook-footer">
                                <img src={ Facebook.src } className="redes-sociais-icone"/>
                            </Link>
                            <Link href="https://www.youtube.com/c/SalesforceBrasil/" target="_blank"className="youtube-footer">
                                <img src={ Youtube.src } className="youtube-icone"/>
                            </Link>
                        </div>
                    </div>
                </div>
                    <nav className="dropdown-selecao">
                    <Link href="https://github.com/Marcondezz/sprintThree-SalesForce" target="_blank">
                        <button className="button">
                        <svg width="45" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
